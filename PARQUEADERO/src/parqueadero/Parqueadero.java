        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    System.out.println("Digite el tipo de vehículo (B: bicicleta, M: motocicleta, C: carro): ");
                    char tipo = sc.next().charAt(0);
                    System.out.println("Digite la hora en la que ingreso: ");
                    int hora = sc.nextInt();
                    Vehiculo vehiculo = new Vehiculo(++con, placa, tipo, hora);
...
public int calcularValor() {
    ...
    int tiempo = Parqueadero.contHora - horaIngreso;
